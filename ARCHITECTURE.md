...
AAA tactical shooter. WebGL2 + Three.js r180, no external art assets — all textures,
...
Every visual subsystem is reviewed by an adversarial critic against modern AAA-shooter
