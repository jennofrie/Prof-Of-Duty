...
const key = new THREE.DirectionalLight(0xfff2e0, 12);
key.position.set(-2.6, 3.4, 3.0);
scene.add(key, key.target);
const fill = new THREE.DirectionalLight(0x9fb8dd, 5.5);
fill.position.set(3.2, 0.6, -1.8);
scene.add(fill);
const rim = new THREE.DirectionalLight(0xffd9b0, 6);
rim.position.set(1.4, -0.8, -3.4);
scene.add(rim);
scene.add(new THREE.HemisphereLight(0x91b4ff, 0x2b2620, 3.2));
