...
export class Movement {
  ...
  _updateStance(cmd, rawInput) {
    ...
    if (this.sliding) {
      ...
      // Sprinting always stands you up; crouched sprinting is intentionally unsupported.
  ...
  _updateSlide(cmd, h, wish, wishLen) {
    ...
    // Slide-cancel: jumping out of a slide preserves an advanced movement option.
