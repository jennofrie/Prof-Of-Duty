...
export const MOVE = {
  ...
  strafeScale: 0.92,
  backScale: 0.8,
  /** ADS movement penalty: roughly half of base speed, with a forgiving bias. */
  adsScale: 0.5,

  /**
   * Ground response. 92 m/s^2 reaches base run speed in 50 ms — effectively
   * instant, which produces a tight shooter response. Deceleration is deliberately
...
export const CAMERA = {
  ...
  land: {
    ...
    damping: 0.52,
    trauma: 0.34,
    /** Hard landings cost health only above a meaningful impact speed. */
    damageSpeed: 15.0,
    damagePerSpeed: 7.0,
  },
...
export const HEALTH = {
  max: 100,
  /** Regen starts 5 s after the last hit and refills in roughly 2.5 s. */
  regenDelay: 4.6,
  regenRate: 34,
  regenRamp: 0.55,
  lowThreshold: 0.36,
